        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createTextbox(x, y) {
				...
				// 在文本框的mousedown事件处理中，修改坐标计算逻辑
				// 查找文本框拖动事件处理函数，替换为以下代码：
            ...
            // 更新文本框数组中的旋转角度
            function updateTextboxRotationInArray(id, rotation) {
                const index = textboxes.findIndex(box => box.id === id);
                if (index !== -1) {
            ...
            // 更新文本框控制面板的值
            function updateTextboxControlValues() {
                ...
                if (index !== -1) {
                    ...
                    document.getElementById('widthValue').textContent = Math.round(box.width);
                    document.getElementById('heightValue').textContent = Math.round(box.height);
