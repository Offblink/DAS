    ...
    function createTextbox(x, y) {
        ...
        textbox.addEventListener('mousedown', function (e) {
            ...
            function drag(e) {
                ...
                // 更新文本框数组中保存的位置
                updateTextboxPositionInArray(textboxId, parseInt(textbox.style.left), parseInt(textbox.style.top));
                // 更新控制面板
                updateTextboxControlValues();
            }
            function stopDrag() {
        ...
        textboxes.forEach(box => {
            ...
            textbox.addEventListener('mousedown', function (e) {
                ...
                function drag(e) {
                    ...
                    textbox.style.left = Math.max(0, Math.min(newX, maxX)) + 'px';
                    textbox.style.top = Math.max(0, Math.min(newY, maxY)) + 'px';
                    updateTextboxPositionInArray(box.id, parseInt(textbox.style.left), parseInt(textbox.style.top));
                    updateTextboxControlValues();
                }
                function stopDrag() {
                    isDraggingTextbox = false;
